...
const getSortedChants = () => {
 ...
 return (
  <div className="max-w-md mx-auto bg-white min-h-screen dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300">
     {/* 헤더 */}
    <div className="bg-white text-gray-900 p-4 border-b border-gray-100 dark:bg-gray-800 dark:text-gray-100 dark:border-gray-700 transition-colors duration-300">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
        <div 
